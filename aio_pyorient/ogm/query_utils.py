import aio_pyorient.ogm.property
import aio_pyorient.ogm.what
from .element import GraphElement
from .operators import ArithmeticOperation, LogicalConnective
...
class ArgConverter(object):
    ...
    def convert_to(conversion, arg, for_query):
        if conversion is ArgConverter.Label:
            return '{}'.format(aio_pyorient.ogm.property.PropertyEncoder.encode_value(arg))
            ...
            if isinstance(arg, aio_pyorient.ogm.property.Property):
                return arg.context_name()
            elif isinstance(arg, GraphElement):
                return arg.registry_name
            elif isinstance(arg, aio_pyorient.ogm.what.What):
            ...
            if isinstance(arg, aio_pyorient.ogm.property.Property):
                ...
                return aio_pyorient.ogm.property.PropertyEncoder.encode_value(arg)
        elif conversion is ArgConverter.Boolean:
            if isinstance(arg, aio_pyorient.ogm.what.What):
                return for_query.build_what(arg)
            else:
                return 'true' if arg else 'false'
        elif conversion is ArgConverter.Name:
            return aio_pyorient.ogm.property.PropertyEncoder.encode_name(arg)
